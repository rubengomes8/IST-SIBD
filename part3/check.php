<html>
	<body>
		...
		echo("<p>$num animals acomplishing the requirements retrieved</p>\n");
		...
		}else if($num == 0 && $num_animals > 0){
			echo("<h3>Animal is already in the database but any consult with the VAT_client provided was found.</h3>\n");
		}
